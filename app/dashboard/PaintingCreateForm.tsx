...
import { createPainting } from '@/lib/actions';
              ...
              <div className="lg:col-span-2">
                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input type="text" name="width" id="width" className="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Width (mm)"  />
                  </div>
                  <div className="md:col-span-2">
                    <label htmlFor="height">Height</label>
                    <input type="text" name="height" id="height" className="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Heigh (mm)"  />
                  </div>
                  <div className="md:col-span-5">
